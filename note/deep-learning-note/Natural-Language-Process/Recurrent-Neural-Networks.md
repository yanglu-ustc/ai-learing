...
<img src="img/屏幕截图%202024-05-03%20214209.png" width=45%>
</div>
...
如果考虑c<t−1>c<t−1>对Γu,Γf,ΓoΓu,Γf,Γo的影响，可加入“窥视孔连接”，对LSTM的表达式进行修改:
...
LSTM主要的区别:比如有一个100维的隐藏记忆细胞单元，第i个 $c^{<t−1>}$ 的元素只会影响第i个元素对应的那个门，所以关系是一对一的，并不是任意这100维的 $c^{<t−1>}$ 可以影响所有的门元素
